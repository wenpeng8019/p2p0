/*
 * test_ping_r_filter.c - ICE 候选过滤测试 (RELAY 模式)
 *
 * ============================================================================
 * 测试场景 (RELAY 模式)
 * ============================================================================
...
///////////////////////////////////////////////////////////////////////////////
// 测试 4: IPv6 only（关闭 IPv4 候选）(RELAY 模式)
///////////////////////////////////////////////////////////////////////////////

static void test_relay_ipv6_only(void) {
    const char *TEST_NAME = "relay_ipv6_only";
    printf("\n--- Test: %s ---\n", TEST_NAME);
    printf("    Disabling IPv4 candidates, IPv6 only (RELAY mode)\n");
    ...
    // 启动 Alice（使用 --no-ipv4 禁用 IPv4，同时禁用 srflx/relay 因为它们当前仅 IPv4）
    ...
    printf("[1] Waiting for connection (IPv6 only, RELAY mode)...\n");
