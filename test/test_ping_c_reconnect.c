/*
 * test_ping_reconnect.c - P2P 重连测试集合
 *
 * ============================================================================
 * 测试场景
 * ============================================================================
...
static void test_both_crash(void) {
    const char *TEST_NAME = "both_crash";
    printf("\n--- Test: %s ---\n", TEST_NAME);
    clear_logs();
...
static void test_single_crash(void) {
    const char *TEST_NAME = "single_crash";
    printf("\n--- Test: %s ---\n", TEST_NAME);
    clear_logs();
