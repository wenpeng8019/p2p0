...
enum {
    ...
    LA_S41,  /* "MSG_REQ retransmit"  [p2p_signal_compact.c] */
    ...
    LA_S51,  /* "No remote candidates to punch"  [p2p_nat.c] */
    ...
    LA_S59,  /* "payload of message type"  [p2p_signal_relay.c] */
    LA_S60,  /* "priority"  [p2p_stun.c] */
    LA_S61,  /* "PseudoTCP enabled as transport layer"  [p2p.c] */
    LA_S62,  /* "PUBSUB (PUB): gathering candidates, waiting for STUN before publishing"  [p2p.c] */
    LA_S63,  /* "PUBSUB (SUB): waiting for offer from any peer"  [p2p.c] */
    LA_S64,  /* "PUBSUB mode requires gh_token and gist_id"  [p2p.c] */
    LA_S65,  /* "received"  [p2p_signal_relay.c] */
    LA_S66,  /* "Received ALIVE_ACK from server"  [p2p_signal_compact.c] */
    LA_S67,  /* "Received FIN packet, connection closed"  [p2p.c] */
    LA_S68,  /* "Received first PEER_INFO with session_id, enter ICE phase"  [p2p_signal_compact.c] */
    LA_S69,  /* "Received REGISTER_ACK with session_id already set, directly enter ICE phase"  [p2p_signal_compact.c] */
    LA_S70,  /* "relay"  [p2p_signal_compact.c] */
    LA_S71,  /* "Relay Candidate"  [p2p_ice.c] */
    LA_S72,  /* "Relay packet received but relay not enabled"  [p2p_signal_compact.c] */
    LA_S73,  /* "RELAY/COMPACT mode requires server_host"  [p2p.c] */
    LA_S74,  /* "request to"  [p2p_signal_relay.c] */
    LA_S75,  /* "Resend remaining candidates and FIN to peer"  [p2p_signal_compact.c] */
    ...
    LA_F97,  /* "PUNCH bidirectional confirmed: NAT_CONNECTED (%s:%d)" (%s,%d)  [p2p_nat.c] */
    LA_F98,  /* "PUNCH rx confirmed: peer->me path is UP (%s:%d)" (%s,%d)  [p2p_nat.c] */
    LA_F99,  /* "PUNCH tx confirmed: me->peer path is UP (peer echoed seq=%u)" (%u)  [p2p_nat.c] */
