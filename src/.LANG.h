...
enum {
    ...
    LA_W60,  /* "punch"  [p2p_nat.c] */
    LA_W61,  /* "Received ACK"  [p2p_signal_relay.c] */
    LA_W62,  /* "Received New Remote Candidate"  [p2p_ice.c] */
    LA_W63,  /* "Received remote candidate"  [p2p_signal_pubsub.c] */
    LA_W64,  /* "Received signal from"  [p2p_signal_relay.c] */
    LA_W65,  /* "recv error"  [p2p_signal_relay.c] */
    LA_W66,  /* "Reliable transport initialized"  [p2p_trans_reliable.c] */
    LA_W67,  /* "Requested"  [p2p_ice.c] */
    LA_W68,  /* "Resent"  [p2p_signal_pubsub.c] */
    LA_W69,  /* "resetting"  [p2p_signal_relay.c] */
    LA_W70,  /* "Restricted Cone NAT"  [p2p_udp.c, p2p_signal_pubsub.c, p2p_trans_pseudotcp.c, p2p_tcp_punch.c, p2p_thread.c, p2p_trans_mbedtls.c, p2p_turn.c, p2p_ice.c, p2p_signal_compact.c, p2p_signal_relay.c, p2p.c, p2p_trans_sctp.c, p2p_probe.c, p2p_trans_openssl.c, p2p_crypto.c, p2p_route.c, p2p_stream.c, p2p_nat.c, p2p_trans_reliable.c, p2p_stun.c, p2p_internal.h] */
    LA_W71,  /* "retry"  [p2p_nat.c] */
    LA_W72,  /* "RTT updated"  [p2p_trans_reliable.c] */
    LA_W73,  /* "Send window full, dropping packet"  [p2p_trans_reliable.c] */
    LA_W74,  /* "Sending"  [p2p_stun.c] */
    LA_W75,  /* "Sending Allocate Request to"  [p2p_turn.c] */
    LA_W76,  /* "Sent answer to"  [p2p_ice.c, p2p_signal_relay.c] */
    LA_W77,  /* "Sent candidates (cached, peer offline)"  [p2p_signal_relay.c] */
    LA_W78,  /* "Sent candidates, forwarded"  [p2p_signal_relay.c] */
    LA_W79,  /* "Sent connect"  [p2p_signal_relay.c] */
    LA_W80,  /* "Server storage full, waiting for peer to come online"  [p2p_signal_relay.c] */
    LA_W81,  /* "Storage full"  [p2p_signal_relay.c] */
    LA_W82,  /* "SUB"  [p2p_signal_pubsub.c] */
    LA_W83,  /* "Success"  [p2p_stun.c] */
    LA_W84,  /* "Symmetric NAT (port-random)"  [p2p_udp.c, p2p_signal_pubsub.c, p2p_trans_pseudotcp.c, p2p_tcp_punch.c, p2p_thread.c, p2p_trans_mbedtls.c, p2p_turn.c, p2p_ice.c, p2p_signal_compact.c, p2p_signal_relay.c, p2p.c, p2p_trans_sctp.c, p2p_probe.c, p2p_trans_openssl.c, p2p_crypto.c, p2p_route.c, p2p_stream.c, p2p_nat.c, p2p_trans_reliable.c, p2p_stun.c, p2p_internal.h] */
    LA_W85,  /* "Test"  [p2p_stun.c] */
    LA_W86,  /* "timed out"  [p2p_signal_relay.c] */
    LA_W87,  /* "Timeout"  [p2p_stun.c] */
    LA_W88,  /* "Timeout (no response)"  [p2p_udp.c, p2p_signal_pubsub.c, p2p_trans_pseudotcp.c, p2p_tcp_punch.c, p2p_thread.c, p2p_trans_mbedtls.c, p2p_turn.c, p2p_ice.c, p2p_signal_compact.c, p2p_signal_relay.c, p2p.c, p2p_trans_sctp.c, p2p_probe.c, p2p_trans_openssl.c, p2p_crypto.c, p2p_route.c, p2p_stream.c, p2p_nat.c, p2p_trans_reliable.c, p2p_stun.c, p2p_internal.h] */
    LA_W89,  /* "to"  [p2p_signal_pubsub.c, p2p_signal_relay.c, p2p_stun.c] */
    LA_W90,  /* "UDP Blocked (STUN unreachable)"  [p2p_udp.c, p2p_signal_pubsub.c, p2p_trans_pseudotcp.c, p2p_tcp_punch.c, p2p_thread.c, p2p_trans_mbedtls.c, p2p_turn.c, p2p_ice.c, p2p_signal_compact.c, p2p_signal_relay.c, p2p.c, p2p_trans_sctp.c, p2p_probe.c, p2p_trans_openssl.c, p2p_crypto.c, p2p_route.c, p2p_stream.c, p2p_nat.c, p2p_trans_reliable.c, p2p_stun.c, p2p_internal.h] */
    LA_W91,  /* "UDP hole-punch probing remote candidates"  [p2p_ice.c] */
    LA_W92,  /* "Unknown"  [p2p_udp.c, p2p_signal_pubsub.c, p2p_trans_pseudotcp.c, p2p_tcp_punch.c, p2p_thread.c, p2p_trans_mbedtls.c, p2p_turn.c, p2p_ice.c, p2p_signal_compact.c, p2p_signal_relay.c, p2p.c, p2p_trans_sctp.c, p2p_probe.c, p2p_trans_openssl.c, p2p_crypto.c, p2p_route.c, p2p_stream.c, p2p_nat.c, p2p_trans_reliable.c, p2p_stun.c, p2p_internal.h] */
    LA_W93,  /* "Unknown ACK status"  [p2p_signal_relay.c] */
    LA_W94,  /* "Unsupported (no STUN/probe configured)"  [p2p_udp.c, p2p_signal_pubsub.c, p2p_trans_pseudotcp.c, p2p_tcp_punch.c, p2p_thread.c, p2p_trans_mbedtls.c, p2p_turn.c, p2p_ice.c, p2p_signal_compact.c, p2p_signal_relay.c, p2p.c, p2p_trans_sctp.c, p2p_probe.c, p2p_trans_openssl.c, p2p_crypto.c, p2p_route.c, p2p_stream.c, p2p_nat.c, p2p_trans_reliable.c, p2p_stun.c, p2p_internal.h] */
    LA_W95,  /* "Waiting for incoming offer from any peer"  [p2p.c] */
    LA_W96,  /* "Waiting for peer"  [p2p_signal_relay.c] */
    LA_W97,  /* "while discarding"  [p2p_signal_relay.c] */
    LA_W98,  /* "while reading payload"  [p2p_signal_relay.c] */
    LA_W99,  /* "while reading sender"  [p2p_signal_relay.c] */
    LA_W100,  /* "will be retried by p2p_update()"  [p2p_ice.c] */
    LA_W101,  /* "yes"  [p2p_ice.c] */
    ...
    LA_F65,  /* "%s: LAN detected and activated: %s:%d" (%s,%s,%d)  [p2p_nat.c] */
    LA_F66,  /* "%s: Peer addr changed -> %s:%d, punch deferred (NAT=%d)" (%s,%s,%d,%d)  [p2p_signal_compact.c] */
    LA_F67,  /* "%s: Peer addr changed -> %s:%d, retrying punch" (%s,%s,%d)  [p2p_signal_compact.c] */
    LA_F68,  /* "%s: RPC fail due to peer offline (sid=%u)" (%s,%u)  [p2p_signal_compact.c] */
    LA_F69,  /* "%s: RPC fail due to relay timeout (sid=%u)" (%s,%u)  [p2p_signal_compact.c] */
    LA_F70,  /* "%s: accepted" (%s)  [p2p_signal_compact.c, p2p_nat.c] */
    LA_F71,  /* "%s: accepted (ses_id=%llu)" (%s,%l)  [p2p_signal_compact.c] */
    LA_F72,  /* "%s: accepted for ack_seq=%u" (%s,%u)  [p2p_signal_compact.c] */
    LA_F73,  /* "%s: accepted for echo_seq=%u" (%s,%u)  [p2p_nat.c] */
    LA_F74,  /* "%s: accepted seq=%u cand_cnt=%d flags=0x%02x" (%s,%u,%d)  [p2p_signal_compact.c] */
    LA_F75,  /* "%s: accepted sid=%u, msg=%u" (%s,%u,%u)  [p2p_signal_compact.c] */
    LA_F76,  /* "%s: accepted, RPC complete (sid=%u)" (%s,%u)  [p2p_signal_compact.c] */
    LA_F77,  /* "%s: accepted, RPC finished (sid=%u)" (%s,%u)  [p2p_signal_compact.c] */
    LA_F78,  /* "%s: accepted, len=%d (ses_id=%llu)" (%s,%d,%l)  [p2p_signal_compact.c] */
    LA_F79,  /* "%s: accepted, probe_mapped=%s:%d" (%s,%s,%d)  [p2p_signal_compact.c] */
    LA_F80,  /* "%s: accepted, public=%s:%d max_cands=%d probe_port=%d relay=%s msg=%s" (%s,%s,%d,%d,%d,%s,%s)  [p2p_signal_compact.c] */
    LA_F81,  /* "%s: accepted, waiting for response (sid=%u)" (%s,%u)  [p2p_signal_compact.c] */
    LA_F82,  /* "%s: bad payload(len=%d cand_cnt=%d)" (%s,%d,%d)  [p2p_signal_compact.c] */
    LA_F83,  /* "%s: bad payload(len=%d)" (%s,%d)  [p2p_signal_compact.c] */
    LA_F84,  /* "%s: bidirectional confirmed: NAT_CONNECTED (%s:%d)" (%s,%s,%d)  [p2p_nat.c] */
    LA_F85,  /* "%s: completed, mapped=%s:%d probe=%s:%d -> %s" (%s,%s,%d,%s,%d,%s)  [p2p_signal_compact.c] */
    ...
    LA_F92,  /* "%s: ignored (relay not supported)" (%s)  [p2p_signal_compact.c] */
    LA_F93,  /* "%s: ignored for duplicated seq=%u, already acked" (%s,%u)  [p2p_signal_compact.c] */
    LA_F94,  /* "%s: ignored for seq=%u (expect=%d)" (%s,%u,%d)  [p2p_signal_compact.c] */
    LA_F95,  /* "%s: ignored for ses_id=%llu (local ses_id=%llu)" (%s,%l,%l)  [p2p_signal_compact.c] */
    LA_F96,  /* "%s: ignored for sid=%u (current sid=%u)" (%s,%u,%u)  [p2p_signal_compact.c] */
    LA_F97,  /* "%s: ignored in invalid state=%d" (%s,%d)  [p2p_signal_compact.c] */
    LA_F98,  /* "%s: ignored in state=%d" (%s,%d)  [p2p_signal_compact.c] */
    LA_F99,  /* "%s: invalid ack_seq=%u" (%s,%u)  [p2p_signal_compact.c] */
    LA_F100,  /* "%s: invalid for non-relay req" (%s)  [p2p_signal_compact.c] */
    LA_F101,  /* "%s: invalid in non-COMPACT mode" (%s)  [p2p_signal_compact.c] */
    LA_F102,  /* "%s: invalid seq=%u" (%s,%u)  [p2p_signal_compact.c] */
    LA_F103,  /* "%s: new request (sid=%u) overrides pending request (sid=%u)" (%s,%u,%u)  [p2p_signal_compact.c] */
    LA_F104,  /* "%s: old request ignored (sid=%u <= last_sid=%u)" (%s,%u,%u)  [p2p_signal_compact.c] */
    LA_F105,  /* "%s: peer disconnected (ses_id=%llu), reset to REGISTERED" (%s,%l)  [p2p_signal_compact.c] */
    LA_F106,  /* "%s: received FIN from peer, marking NAT as CLOSED" (%s)  [p2p_nat.c] */
    LA_F107,  /* "%s: remote candidate[%d] %s:%d, starting punch" (%s,%d,%s,%d)  [p2p_signal_compact.c] */
    LA_F108,  /* "%s: retry(%d/%d) probe" (%s,%d,%d)  [p2p_signal_compact.c] */
    LA_F109,  /* "%s: retry(%d/%d) req (sid=%u)" (%s,%d,%d,%u)  [p2p_signal_compact.c] */
    LA_F110,  /* "%s: retry(%d/%d) resp (sid=%u)" (%s,%d,%d,%u)  [p2p_signal_compact.c] */
    LA_F111,  /* "%s: retry, (attempt %d/%d)" (%s,%d,%d)  [p2p_signal_compact.c] */
    LA_F112,  /* "%s: rx confirmed: peer->me path is UP (%s:%d)" (%s,%s,%d)  [p2p_nat.c] */
    LA_F113,  /* "%s: sent, sid=%u, code=%u, size=%d" (%s,%u,%u,%d)  [p2p_signal_compact.c] */
    LA_F114,  /* "%s: session mismatch(local=%llu pkt=%llu)" (%s,%l,%l)  [p2p_signal_compact.c] */
    LA_F115,  /* "%s: session mismatch(local=%llu, pkt=%llu)" (%s,%l,%l)  [p2p_signal_compact.c] */
    LA_F116,  /* "%s: skip and mark NAT as OPEN (lan_punch enabled)" (%s)  [p2p_signal_compact.c] */
    LA_F117,  /* "%s: started, sending first probe" (%s)  [p2p_signal_compact.c] */
    LA_F118,  /* "%s: status error(%d)" (%s,%d)  [p2p_signal_compact.c] */
    LA_F119,  /* "%s: sync complete (ses_id=%llu)" (%s,%l)  [p2p_signal_compact.c] */
    LA_F120,  /* "%s: sync complete (ses_id=%llu, mask=0x%04x)" (%s,%l)  [p2p_signal_compact.c] */
    LA_F121,  /* "%s: timeout after %d ms, restarting signaling (UNREGISTER + RE-REGISTER)" (%s,%d)  [p2p_signal_compact.c] */
    LA_F122,  /* "%s: timeout after %d retries , type unknown" (%s,%d)  [p2p_signal_compact.c] */
    LA_F123,  /* "%s: timeout, max(%d) attempts reached, reset to INIT" (%s,%d)  [p2p_signal_compact.c] */
    LA_F124,  /* "%s: tx confirmed: me->peer path is UP (peer echoed seq=%u)" (%s,%u)  [p2p_nat.c] */
    LA_F125,  /* "%s: unexpected ack_seq=%u mask=0x%04x" (%s,%u)  [p2p_signal_compact.c] */
    LA_F126,  /* "%s:%04d: %s" (%s,%s)  [p2p_trans_mbedtls.c] */
    LA_F127,  /* "%s_ACK sent, seq=%u (ses_id=%llu)" (%s,%u,%l)  [p2p_signal_compact.c] */
    LA_F128,  /* "%s_ACK sent, sid=%u" (%s,%u)  [p2p_signal_compact.c] */
    LA_F129,  /* "ATTEMPT: punch to %d/%d candidates (elapsed: %llu ms)" (%d,%d,%l)  [p2p_nat.c] */
    LA_F130,  /* "Added PUNCH path to path manager, idx=%d" (%d)  [p2p.c] */
    LA_F131,  /* "Added RELAY path to path manager, idx=%d" (%d)  [p2p.c] */
    LA_F132,  /* "Append Host candidate: %s:%d" (%s,%d)  [p2p.c] */
    LA_F133,  /* "Attempting Simultaneous Open to %s:%d" (%s,%d)  [p2p_tcp_punch.c] */
    LA_F134,  /* "Auto-send answer (with %d candidates) total sent %s" (%d,%s)  [p2p_signal_pubsub.c] */
    LA_F135,  /* "Connect to COMPACT signaling server failed(%d)" (%d)  [p2p.c] */
    LA_F136,  /* "Connect to RELAY signaling server failed(%d)" (%d)  [p2p.c] */
    LA_F137,  /* "Connecting to RELAY signaling server at %s:%d" (%s,%d)  [p2p.c] */
    LA_F138,  /* "Detect local network interfaces failed(%d)" (%d)  [p2p.c] */
    LA_F139,  /* "Failed to realloc memory for local candidates (capacity: %d)" (%d)  [p2p_udp.c, p2p_signal_pubsub.c, p2p_trans_pseudotcp.c, p2p_tcp_punch.c, p2p_thread.c, p2p_trans_mbedtls.c, p2p_turn.c, p2p_ice.c, p2p_signal_compact.c, p2p_signal_relay.c, p2p.c, p2p_trans_sctp.c, p2p_probe.c, p2p_trans_openssl.c, p2p_crypto.c, p2p_route.c, p2p_stream.c, p2p_nat.c, p2p_trans_reliable.c, p2p_stun.c, p2p_internal.h] */
    LA_F140,  /* "Failed to realloc memory for remote candidates (capacity: %d)" (%d)  [p2p_udp.c, p2p_signal_pubsub.c, p2p_trans_pseudotcp.c, p2p_tcp_punch.c, p2p_thread.c, p2p_trans_mbedtls.c, p2p_turn.c, p2p_ice.c, p2p_signal_compact.c, p2p_signal_relay.c, p2p.c, p2p_trans_sctp.c, p2p_probe.c, p2p_trans_openssl.c, p2p_crypto.c, p2p_route.c, p2p_stream.c, p2p_nat.c, p2p_trans_reliable.c, p2p_stun.c, p2p_internal.h] */
    LA_F141,  /* "Failed to reserve remote candidates (base=%u cnt=%d)" (%u,%d)  [p2p_signal_compact.c] */
    LA_F142,  /* "Failed to reserve remote candidates (cnt=%d)" (%d)  [p2p_signal_compact.c] */
    LA_F143,  /* "Field %s is empty or too short" (%s)  [p2p_signal_pubsub.c] */
    LA_F144,  /* "Handshake failed: %s (-0x%04x)" (%s)  [p2p_trans_mbedtls.c] */
    LA_F145,  /* "Ignoring punch request for candidate %d since already connected" (%d)  [p2p_nat.c] */
    LA_F146,  /* "Initialize PUBSUB signaling context failed(%d)" (%d)  [p2p.c] */
    LA_F147,  /* "Initialize signaling mode: %d" (%d)  [p2p.c] */
    LA_F148,  /* "Invalid candidate index: %d (count: %d)" (%d,%d)  [p2p_nat.c] */
    LA_F149,  /* "Open P2P UDP socket on port %d" (%d)  [p2p.c] */
    LA_F150,  /* "Open P2P UDP socket on port %d failed(%d)" (%d,%d)  [p2p.c] */
    LA_F151,  /* "Path manager initialized with strategy: %d (0=conn,1=perf,2=hybrid)" (%d)  [p2p.c] */
    LA_F152,  /* "Path recovered: switched to %s" (%s)  [p2p.c] */
    LA_F153,  /* "Path switched: %s -> %s (RTT: %u -> %u ms)" (%s,%s,%u,%u)  [p2p.c] */
    LA_F154,  /* "Peer IP %s does not match any local network segment" (%s)  [p2p_route.c] */
    LA_F155,  /* "Peer IP %s matches local network segment %s (connectivity pending probe)" (%s,%s)  [p2p_route.c] */
    LA_F156,  /* "Processing (role=%s)" (%s)  [p2p_signal_pubsub.c] */
    LA_F157,  /* "Punch timeout but ICE exchange not done yet (%llu ms elapsed, mode=%d), waiting for more candidates" (%l,%d)  [p2p_nat.c] */
    LA_F158,  /* "Punching remote candidate(%d) %s:%d" (%d,%s,%d)  [p2p_nat.c] */
    LA_F159,  /* "REGISTERED: peer=%s" (%s)  [p2p_signal_compact.c] */
    LA_F160,  /* "Received %s pkt from %s:%d" (%s,%s,%d)  [p2p_signal_compact.c] */
    LA_F161,  /* "Received %s pkt from %s:%d, flags=0x%02x, len=%d" (%s,%s,%d,%d)  [p2p_signal_compact.c] */
    LA_F162,  /* "Received %s pkt from %s:%d, len=%d" (%s,%s,%d,%d)  [p2p_signal_compact.c] */
    LA_F163,  /* "Received %s pkt from %s:%d, seq=%u, flags=0x%02x, len=%d" (%s,%s,%d,%u,%d)  [p2p_signal_compact.c] */
    LA_F164,  /* "Received %s pkt from %s:%d, seq=%u, len=%d" (%s,%s,%d,%u,%d)  [p2p_signal_compact.c, p2p_nat.c] */
    LA_F165,  /* "Received %s pkt from %s:%d, seq=0, len=0" (%s,%s,%d)  [p2p_nat.c] */
    LA_F166,  /* "Received ACK pkt from %s:%d, ack_seq=%u, sack=0x%08x" (%s,%d,%u)  [p2p.c] */
    LA_F167,  /* "Received DATA pkt from %s:%d, seq=%u, len=%d" (%s,%d,%u,%d)  [p2p.c] */
    ...
    LA_F181,  /* "Send offer to RELAY signaling server failed(%d)" (%d)  [p2p.c] */
    LA_F182,  /* "Sent UNREGISTER Pkt for local_peer_id=%s, remote_peer_id=%s" (%s,%s)  [p2p.c] */
    LA_F183,  /* "Sent initial offer(%d) to %s)" (%d,%s)  [p2p.c] */
    LA_F184,  /* "Start internal thread failed(%d)" (%d)  [p2p.c] */
    LA_F185,  /* "Start punching all(%d) remote candidates" (%d)  [p2p_nat.c] */
    LA_F186,  /* "Switched to backup path: %s" (%s)  [p2p.c] */
    LA_F187,  /* "TIMEOUT: No response from peer for (%llu ms), connection lost" (%l)  [p2p_nat.c] */
    LA_F188,  /* "TIMEOUT: Punch failed after %llu ms (ICE done), switching to RELAY" (%l)  [p2p_nat.c] */
    LA_F189,  /* "Unknown signaling mode: %d" (%d)  [p2p.c] */
    LA_F190,  /* "Updating Gist field '%s'..." (%s)  [p2p_signal_pubsub.c] */
    LA_F191,  /* "Using path: %s" (%s)  [p2p.c] */
    LA_F192,  /* "[DEBUG] %s %d %s %s %d" (%s,%d,%s,%s,%d)  [p2p_signal_relay.c] */
    LA_F193,  /* "[DEBUG] %s received (ice_state=%d), resetting ICE and clearing %d stale candidates" (%s,%d,%d)  [p2p_signal_relay.c] */
    LA_F194,  /* "[DEBUG] First offer, resetting ICE and clearing %d stale candidates" (%d)  [p2p_signal_pubsub.c] */
    LA_F195,  /* "[DEBUG] relay_tick: recv header complete, magic=0x%x, type=%d, length=%u" (%x,%d,%u)  [p2p_signal_relay.c] */
    LA_F196,  /* "[SCTP] received encapsulated packet, length %d" (%d)  [p2p_trans_sctp.c] */
    LA_F197,  /* "[SCTP] sending %d bytes" (%d)  [p2p_trans_sctp.c] */
    LA_F198,  /* "[Trickle] Immediately probing new candidate %s:%d" (%s,%d)  [p2p_signal_pubsub.c, p2p_signal_relay.c] */
    LA_F199,  /* "[lan_punch] 启动 PUNCH 流程 (Host 候选 %d 个)" (%d)  [p2p_ice.c] */
    LA_F200,  /* "[prflx] %s %s:%d (Peer Reflexive - symmetric NAT)" (%s,%s,%d)  [p2p_ice.c] */
    LA_F201,  /* "congestion detected, new ssthresh: %u, cwnd: %u" (%u,%u)  [p2p_trans_pseudotcp.c] */
    LA_F202,  /* "probe(compact) SUCCESS: peer reachable via server (RTT: %llu ms)" (%l)  [p2p_probe.c] */
    LA_F203,  /* "probe(compact) send failed: ret=%d" (%d)  [p2p_probe.c] */
    LA_F204,  /* "probe(compact) sent: MSG(msg=0, sid=%u)" (%u)  [p2p_probe.c] */
    LA_F205,  /* "probe(compact) timeout, retry %d/%d" (%d,%d)  [p2p_probe.c] */
    LA_F206,  /* "probe(relay) SUCCESS: UDP reachable via TURN (RTT: %llu ms)" (%l)  [p2p_probe.c] */
    LA_F207,  /* "probe(relay) TURN allocation failed: ret=%d" (%d)  [p2p_probe.c] */
    LA_F208,  /* "probe(relay) TURN timeout, retry %d/%d" (%d,%d)  [p2p_probe.c] */
    LA_F209,  /* "probe(relay) UDP timeout, retry %d/%d" (%d,%d)  [p2p_probe.c] */
    LA_F210,  /* "probe(relay) exchange timeout, retry %d/%d" (%d,%d)  [p2p_probe.c] */
    LA_F211,  /* "send ACK ack_seq=%u sack=0x%08x recv_base=%u to %s:%d" (%u,%u,%s,%d)  [p2p_trans_reliable.c] */
    LA_F212,  /* "ssl_setup failed: -0x%x" (%x)  [p2p_trans_mbedtls.c] */
    LA_F213,  /* "✓ %s %s %s:%d (%s=%u)" (%s,%s,%s,%d,%s,%u)  [p2p_stun.c] */
    LA_F214,  /* "✗ %s" (%s)  [p2p_stun.c] */
    LA_F215,  /* "连通性检查超时（已发送 %d 轮），放弃" (%d)  [p2p_ice.c] */
    LA_F216,  /* "重传 seq=%u retx=%d rto=%d" (%u,%d,%d)  [p2p_trans_reliable.c] */
