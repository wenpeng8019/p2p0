...
static const char* messages_en[MSG_COUNT] = {
    ...
    [MSG_P2P_COMPACT_SKIP_HOST]     = "Skipping local Host candidates",
    [MSG_P2P_WAITING_FOR]           = "waiting for",
    ...
    [MSG_ICE_CONNECTIVITY_CHECK] = "UDP hole-punch probing remote candidates",
    ...
    [MSG_STUN_SRFLX_ADD_FAILED] = "Cannot add Srflx candidate: realloc failed (OOM)",
...
static const char* messages_zh[MSG_COUNT] = {
    ...
    [MSG_P2P_COMPACT_HOST_CAND]     = "已添加本地候选",    [MSG_P2P_COMPACT_SKIP_HOST]     = "跳过本地Host候选",
    [MSG_P2P_WAITING_FOR]           = "等待",    [MSG_P2P_COMPACT_REGISTERING]   = "COMPACT: 注册中",
    ...
    [MSG_ICE_CONNECTIVITY_CHECK] = "UDP 打洞探测对端候选地址",
    ...
    [MSG_STUN_SRFLX_ADD_FAILED] = "无法添加 Srflx 候选：内存分配失败 (OOM)",
    [MSG_STUN_SUCCESS]          = "成功",
    [MSG_STUN_NEED]             = "需要",
