...
const char* lang_en[LA_NUM] = {
    ...
    [LA_S37] = "[SIGNALING] Server storage full, waiting for peer to come online",  /* SID:37 */
    [LA_S38] = "[Trickle] TCP not connected, skipping single candidate send",  /* SID:38 */
    [LA_S39] = "Added SIGNALING path to path manager",  /* SID:39 */
    [LA_S40] = "Answer already present, skipping offer re-publish",  /* SID:40 */
    [LA_S41] = "Base64 decode failed",  /* SID:41 */
    [LA_S42] = "Bind failed",  /* SID:42 */
    [LA_S43] = "BIO_new failed",  /* SID:43 */
    [LA_S44] = "Channel ID validation failed",  /* SID:44 */
    [LA_S45] = "Close P2P UDP socket",  /* SID:45 */
    [LA_S46] = "Closing TCP connection to RELAY signaling server",  /* SID:46 */
    [LA_S47] = "COMPACT mode requires explicit remote_peer_id",  /* SID:47 */
    [LA_S48] = "Connection closed by server",  /* SID:48 */
    [LA_S49] = "Connection closed while discarding",  /* SID:49 */
    [LA_S50] = "Connection closed while reading payload",  /* SID:50 */
    [LA_S51] = "Connection closed while reading sender",  /* SID:51 */
    [LA_S52] = "Detecting local network addresses",  /* SID:52 */
    [LA_S53] = "DTLS (MbedTLS) enabled as encryption layer",  /* SID:53 */
    [LA_S54] = "DTLS handshake complete (MbedTLS)",  /* SID:54 */
    [LA_S55] = "Failed to allocate ACK payload buffer",  /* SID:55 */
    [LA_S56] = "Failed to allocate discard buffer, closing connection",  /* SID:56 */
    [LA_S57] = "Failed to allocate DTLS context",  /* SID:57 */
    [LA_S58] = "Failed to allocate memory for candidate lists",  /* SID:58 */
    ...
    [LA_S70] = "Invalid channel_id format (security risk)",  /* SID:70 */
    [LA_S71] = "Invalid signaling mode in configuration",  /* SID:71 */
    [LA_S72] = "NAT connection recovered, upgrading from RELAY to CONNECTED",  /* SID:72 */
    [LA_S73] = "NAT connection timeout, downgrading to relay mode",  /* SID:73 */
    [LA_S74] = "No advanced transport layer enabled, using simple reliable layer",  /* SID:74 */
    [LA_S75] = "No auth_key provided, using default key (insecure)",  /* SID:75 */
    [LA_S76] = "OpenSSL requested but library not linked",  /* SID:76 */
    [LA_S77] = "Out of memory",  /* SID:77 */
    [LA_S78] = "P2P connected, closing signaling TCP connection",  /* SID:78 */
    [LA_S79] = "P2P connection established",  /* SID:79 */
    [LA_S80] = "P2P punch failed, adding relay path",  /* SID:80 */
    [LA_S81] = "P2P punching in progress ...",  /* SID:81 */
    [LA_S82] = "p2p_ice_send_local_candidate called in non-RELAY mode",  /* SID:82 */
    [LA_S83] = "Path switch debounced, waiting for stability",  /* SID:83 */
    [LA_S84] = "PseudoTCP enabled as transport layer",  /* SID:84 */
    ...
    [LA_S91] = "Sending FIN packet to peer before closing",  /* SID:91 */
    [LA_S92] = "Sending UNREGISTER packet to COMPACT signaling server",  /* SID:92 */
    [LA_S93] = "Signal payload deserialization failed",  /* SID:93 */
    [LA_S94] = "Skipping local Host candidates on --public-only",  /* SID:94 */
    [LA_S95] = "SSL_CTX_new failed",  /* SID:95 */
    [LA_S96] = "SSL_new failed",  /* SID:96 */
    [LA_S97] = "Starting internal thread",  /* SID:97 */
    [LA_S98] = "Stopping internal thread",  /* SID:98 */
    [LA_S99] = "Storage full, waiting for peer to come online",  /* SID:99 */
    [LA_S100] = "Switched to backup path: RELAY",  /* SID:100 */
    [LA_S101] = "TURN auth required but no credentials configured",  /* SID:101 */
    [LA_S102] = "Using path: RELAY",  /* SID:102 */
    [LA_F103] = "  ... and %d more pairs",  /* SID:103 */
    [LA_F104] = "  [%d] %s/%d",  /* SID:104 */
    ...
    [LA_F206] = "Attempting Simultaneous Open to %s:%d",  /* SID:206 */
    [LA_F207] = "Auto-send answer (with %d candidates) total sent %s",  /* SID:207 */
    [LA_F208] = "Bind failed to %d, port busy, trying random port",  /* SID:208 */
    [LA_F209] = "Bound to :%d",  /* SID:209 */
    [LA_F210] = "Connect to COMPACT signaling server failed(%d)",  /* SID:210 */
    [LA_F211] = "Connect to RELAY signaling server failed(%d)",  /* SID:211 */
    [LA_F212] = "Connected to server %s:%d as '%s'",  /* SID:212 */
    [LA_F213] = "Connecting to RELAY signaling server at %s:%d",  /* SID:213 */
    [LA_F214] = "Connectivity checks timed out (sent %d rounds), giving up",  /* SID:214 */
    [LA_F215] = "Crypto layer '%s' init failed, continuing without encryption",  /* SID:215 */
    [LA_F216] = "Data stored in recv buffer seq=%u len=%d base=%u",  /* SID:216 */
    [LA_F217] = "Detect local network interfaces failed(%d)",  /* SID:217 */
    ...
    [LA_F265] = "Received remote candidate: type=%d, address=%s:%d",  /* SID:265 */
    [LA_F266] = "Received valid signal from '%s'",  /* SID:266 */
    ...
    [LA_F290] = "Sending Test I to %s:%d (len=%d)",  /* SID:290 */
    [LA_F291] = "Sent answer to '%s'",  /* SID:291 */
    [LA_F292] = "Sent answer to '%s' (%d bytes)",  /* SID:292 */
    ...
    [LA_F300] = "TURN CreatePermission failed (error=%d)",  /* SID:300 */
    [LA_F301] = "TURN CreatePermission for %s",  /* SID:301 */
    [LA_F302] = "TURN Data Indication from %s:%u (%d bytes)",  /* SID:302 */
    ...
    [LA_F320] = "[SCTP] association lost/shutdown (state=%u)",  /* SID:320 */
    [LA_F321] = "[SCTP] bind failed: %s",  /* SID:321 */
    [LA_F322] = "[SCTP] connect failed: %s",  /* SID:322 */
    [LA_F323] = "[SCTP] sendv failed: %s",  /* SID:323 */
    [LA_F324] = "[SIGNALING] Failed to send candidates, will retry (ret=%d)",  /* SID:324 */
    [LA_F325] = "[SIGNALING] Sent candidates (cached, peer offline) %d to %s",  /* SID:325 */
    [LA_F326] = "[SIGNALING] Sent candidates, forwarded [%d-%d] to %s (forwarded=%d)",  /* SID:326 */
    ...
    [LA_F335] = "recv error %d while discarding",  /* SID:335 */
    [LA_F336] = "recv error %d while reading payload",  /* SID:336 */
    [LA_F337] = "recv error %d while reading sender",  /* SID:337 */
    [LA_F338] = "relay_tick: recv header complete, magic=0x%x, type=%d, length=%u",  /* SID:338 */
    [LA_F339] = "retry seq=%u retx=%d rto=%d",  /* SID:339 */
    [LA_F340] = "send ACK ack_seq=%u sack=0x%08x recv_base=%u to %s:%d",  /* SID:340 */
    [LA_F341] = "ssl_config_defaults failed: -0x%x",  /* SID:341 */
