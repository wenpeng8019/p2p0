...
const char* lang_en[LA_NUM] = {
    ...
    [LA_F17] = "%s sent, size=%d (ses_id=%llu)",  /* SID:421 */
    [LA_F18] = "%s sent, total=%d (ses_id=%llu)",  /* SID:422 */
    ...
    [LA_F28] = "%s: SUCCESS: UDP reachable via TURN (RTT: %llu ms)",  /* SID:423 */
    ...
    [LA_F34] = "%s: accepted (ses_id=%llu)",  /* SID:424 */
    ...
    [LA_F41] = "%s: accepted, len=%d (ses_id=%llu)",  /* SID:425 */
    ...
    [LA_F63] = "%s: ignored for ses_id=%llu (local ses_id=%llu)",  /* SID:426 */
    ...
    [LA_F76] = "%s: no response for %llu ms, connection lost",  /* SID:427 */
    [LA_F77] = "%s: old request ignored (sid=%u <= last_sid=%u)",  /* SID:168 */
    [LA_F78] = "%s: peer disconnected (ses_id=%llu), reset to REGISTERED",  /* SID:428 */
    [LA_F79] = "%s: peer reachable via signaling (RTT: %llu ms)",  /* SID:429 */
    [LA_F80] = "%s: punching %d/%d candidates (elapsed: %llu ms)",  /* SID:430 */
    ...
    [LA_F94] = "%s: session mismatch(local=%llu pkt=%llu)",  /* SID:431 */
    [LA_F95] = "%s: session mismatch(local=%llu, pkt=%llu)",  /* SID:432 */
    ...
    [LA_F100] = "%s: sync complete (ses_id=%llu)",  /* SID:433 */
    [LA_F101] = "%s: sync complete (ses_id=%llu, mask=0x%04x)",  /* SID:434 */
    ...
    [LA_F104] = "%s: timeout after %llu ms (ICE done), switching to RELAY",  /* SID:435 */
    [LA_F105] = "%s: timeout but ICE exchange not done yet (%llu ms elapsed, mode=%d), waiting for more candidates",  /* SID:436 */
    ...
    [LA_F114] = "%s_ACK sent, seq=%u (ses_id=%llu)",  /* SID:437 */
