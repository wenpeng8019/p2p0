...
enum {
    ...
    LA_S16,  /* "=== P2P Ping Diagnostic Tool ==="  [p2p_ping.c] */
    LA_S17,  /* "[Chat] Echo mode enabled: received messages will be echoed back."  [p2p_ping.c] */
    LA_S18,  /* "[Chat] Entering message mode. Type and press Enter to send. Ctrl+C to quit."  [p2p_ping.c] */
    LA_S19,  /* "[EVENT] Connection closed"  [p2p_ping.c] */
    LA_S20,  /* "[TEST] LAN punch mode: PUNCH/PUNCH_ACK over Host candidates (nat_start_punch)"  [p2p_ping.c] */
    LA_S21,  /* "[TEST] LAN shortcut disabled - forcing NAT punch"  [p2p_ping.c] */
    ...
    LA_F0,  /* "Running in %s mode (connecting to %s)..." (%s,%s)  [p2p_ping.c] */
    LA_F1,  /* "Running in %s mode (waiting for connection)..." (%s)  [p2p_ping.c] */
    LA_F2,  /* "Usage: %s [options]" (%s)  [p2p_ping.c] */
    LA_F3,  /* "[STATE] %s (%d) -> %s (%d)" (%s,%d,%s,%d)  [p2p_ping.c] */
