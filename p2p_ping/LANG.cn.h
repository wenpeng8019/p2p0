...
static const char* s_lang_cn[LA_NUM] = {
    ...
    [LA_S41] = "% Timeout waiting for debugger. Continuing without debugger.\n",  /* [SID:41] UPDATED new: "Disable IPv4 candidates (for testing)" */
    [LA_S42] = "Waiting Debugger(%s) connecting...\n",  /* [SID:42] UPDATED new: "Disable IPv6 candidates (for testing)" */
    ...
    [LA_S47] = "Enable multi-path Srflx (per-interface STUN)",  /* SID:47 new */
    [LA_S20] = "Enable PseudoTCP",  /* SID:20 */
    [LA_S21] = "GitHub Gist ID for Public Signaling",  /* [SID:21] UPDATED new: "GitHub Gist ID for Pub/Sub Signaling" */
    [LA_S22] = "GitHub Token for Public Signaling",  /* [SID:22] UPDATED new: "GitHub Token for Pub/Sub Signaling" */
    ...
    [LA_S32] = "Use COMPACT mode (UDP signaling, default is ICE/TCP)",  /* [SID:32] UPDATED new: "Use COMPACT mode (UDP signaling, default is TCP/RELAY)" */
    [LA_S35] = "% Debugger connected, resuming execution.\n",  /* [SID:35] UPDATED new: "Use WSS mode (WebSocket signaling, default is TCP/RELAY)" */
    [LA_S34] = "% === P2P Ping Diagnostic Tool ===\n",  /* [SID:34] UPDATED new: "Wait for STUN srflx candidates before sync" */
    ...
    [LA_F37] = "% Failed to initialize connection\n",  /* [SID:37] UPDATED new: "% Failed to initialize PUBSUB SUB session\n" */
