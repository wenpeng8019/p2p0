...
static const char* s_lang_en[LA_NUM] = {
    ...
    [LA_S41] = "Disable IPv4 candidates (for testing)",  /* SID:41 */
    [LA_S42] = "Disable IPv6 candidates (for testing)",  /* SID:42 */
    ...
    [LA_S47] = "Enable multi-path Srflx (per-interface STUN)",  /* SID:47 */
    [LA_S20] = "Enable PseudoTCP",  /* SID:20 */
    [LA_S21] = "GitHub Gist ID for Pub/Sub Signaling",  /* SID:21 */
    [LA_S22] = "GitHub Token for Pub/Sub Signaling",  /* SID:22 */
    ...
    [LA_S32] = "Use COMPACT mode (UDP signaling, default is TCP/RELAY)",  /* SID:32 */
    [LA_S35] = "Use WSS mode (WebSocket signaling, default is TCP/RELAY)",  /* SID:35 */
    [LA_S34] = "Wait for STUN srflx candidates before sync",  /* SID:34 */
